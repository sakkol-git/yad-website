...
const ALLOCATION_DATA = [
  { name: 'Student Programs', percentage: 78, description: 'Direct scholarship, dormitory, and mentorship costs', color: CHART_TOKENS.primary },
  { name: 'Operations', percentage: 12, description: 'Staff, facilities, administration', color: CHART_TOKENS.secondary },
  { name: 'Training & Events', percentage: 7, description: 'Leadership bootcamps, workshops', color: CHART_TOKENS.tertiary },
  { name: 'Fundraising', percentage: 3, description: 'Communications and donor relations', color: CHART_TOKENS.surfaceVariant },
];
...
*Classification: Internal Development Document — YAD Web Team*
