...
<div class="w-8 h-8 rounded-full bg-primary text-on-primary flex items-center justify-center font-label-bold text-label-bold" id="indicator-1">1</div>
<span class="font-label-bold text-label-bold text-primary hidden md:inline">Details</span>
</div>
<div class="h-px bg-surface-variant flex-grow"></div>
<div class="flex items-center gap-2">
<div class="w-8 h-8 rounded-full bg-surface-variant text-on-surface-variant flex items-center justify-center font-label-bold text-label-bold transition-colors" id="indicator-2">2</div>
<span class="font-label-bold text-label-bold text-on-surface-variant hidden md:inline transition-colors" id="label-2">Payment</span>
</div>
<div class="h-px bg-surface-variant flex-grow"></div>
<div class="flex items-center gap-2">
<div class="w-8 h-8 rounded-full bg-surface-variant text-on-surface-variant flex items-center justify-center font-label-bold text-label-bold transition-colors" id="indicator-3">3</div>
<span class="font-label-bold text-label-bold text-on-surface-variant hidden md:inline transition-colors" id="label-3">Review</span>
</div>
</div>
...
<div class="" id="step-1">
<h2 class="font-headline-md text-headline-md text-primary mb-6">Select Amount</h2>
<div class="grid grid-cols-3 gap-4 mb-6">
<button class="amount-btn bg-surface-container text-on-surface hover:bg-surface-variant font-label-bold text-label-bold py-4 rounded-xl transition-colors border border-transparent" data-amount="25" type="button">$25</button>
<button class="amount-btn bg-primary-container text-on-primary-container ring-2 ring-primary font-label-bold text-label-bold py-4 rounded-xl transition-colors border border-transparent" data-amount="50" type="button">$50</button>
<button class="amount-btn bg-surface-container text-on-surface hover:bg-surface-variant font-label-bold text-label-bold py-4 rounded-xl transition-colors border border-transparent" data-amount="100" type="button">$100</button>
</div>
<div class="mb-8 relative">
<span class="absolute left-4 top-1/2 -translate-y-1/2 font-body-lg text-body-lg text-on-surface-variant">$</span>
<input class="stripe-input pl-8" id="custom-amount" placeholder="Custom Amount" type="number"/>
</div>
<h2 class="font-headline-md text-headline-md text-primary mb-6">Your Information</h2>
<div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
<div>
<label class="block font-label-bold text-label-bold text-on-surface mb-2">First Name</label>
<input class="stripe-input" placeholder="Jane" required="" type="text"/>
</div>
<div>
<label class="block font-label-bold text-label-bold text-on-surface mb-2">Last Name</label>
<input class="stripe-input" placeholder="Doe" required="" type="text"/>
</div>
<div class="md:col-span-2">
<label class="block font-label-bold text-label-bold text-on-surface mb-2">Email Address</label>
<input class="stripe-input" placeholder="jane.doe@example.com" required="" type="email"/>
</div>
</div>
<div class="flex justify-end">
<button class="bg-secondary text-on-secondary font-label-bold text-label-bold py-3 px-8 rounded-full hover:scale-105 transition-transform flex items-center gap-2" onclick="goToStep(2)" type="button">
...
export const Route = createFileRoute("/donate/flow")({
