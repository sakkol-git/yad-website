          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-8 mb-16">
            ...
            <div className="lg:col-span-4 flex flex-col items-start text-left gap-8 lg:pr-12">
              <Link href="/" className="flex items-center gap-4 group w-fit focus-visible:outline-none">
                <div className="relative flex items-center justify-center w-14 h-14 bg-surface-container rounded-xl border border-outline-variant/30 transition-transform duration-500 group-hover:scale-105 group-hover:border-primary/40 group-hover:shadow-md">
                  <Image
            ...
            <div className="lg:col-span-4 flex flex-col items-start text-left gap-6">
              ...
              <div className="flex flex-col gap-5 mt-4">
                <a href="https://maps.app.goo.gl/5AhtYGNDRfVjH8cY8" target="_blank" rel="noopener noreferrer" className="flex items-start gap-4 group p-3 rounded-xl hover:bg-surface-container transition-colors border border-transparent hover:border-outline-variant/30 -ml-3">
                  <div className="flex-shrink-0 mt-1 bg-primary/10 p-2 rounded-lg text-primary group-hover:scale-110 transition-transform">
                  ...
                  <span className="text-sm font-medium text-on-surface-variant group-hover:text-primary transition-colors leading-relaxed">
                    YAD Cambodia<br/>
                    <span className="text-xs text-secondary mt-1 block">View on Google Maps &rarr;</span>
                  </span>
                </a>
                
                <a href="tel:+85599332289" className="flex items-center gap-4 group p-3 rounded-xl hover:bg-surface-container transition-colors border border-transparent hover:border-outline-variant/30 -ml-3">
                  <div className="flex-shrink-0 bg-primary/10 p-2 rounded-lg text-primary group-hover:scale-110 transition-transform">
                ...
                <a href="mailto:info@yadkh.org" className="flex items-center gap-4 group p-3 rounded-xl hover:bg-surface-container transition-colors border border-transparent hover:border-outline-variant/30 -ml-3">
                  <div className="flex-shrink-0 bg-primary/10 p-2 rounded-lg text-primary group-hover:scale-110 transition-transform">
