    ...
    <div className="flex flex-col gap-4">
      <div className="flex justify-end">
        <div className="relative">
          ...
          {showColumnToggle && (
            <div className="absolute right-0 top-full mt-2 w-48 bg-surface-container-lowest border border-outline-variant/30 rounded-lg shadow-lg z-10 p-2 animate-in fade-in zoom-in-95">
              ...
              {colsWithId.filter(c => c.enableHiding !== false).map(col => (
                <label key={col.id} className="flex items-center gap-2 px-2 py-1.5 hover:bg-surface rounded cursor-pointer text-sm text-on-surface">
                  <input 
                    type="checkbox" 
