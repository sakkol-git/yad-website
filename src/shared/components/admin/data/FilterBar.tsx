...
export function FilterBar({ 
  ...
  return (
    <div className="bg-surface-container-lowest p-4 rounded-lg border border-outline-variant/30 mb-6 flex flex-col sm:flex-row gap-4 items-center justify-between shadow-sm">
