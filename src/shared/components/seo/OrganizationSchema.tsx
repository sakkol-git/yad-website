export function OrganizationSchema() {
  const schema = {
    ...
    description:
      "Youth Advancement for Development (YAD) is a Cambodian NGO empowering youth to lead tomorrow through education, digital innovation, dormitory programs, and community development.",
    foundingDate: "2020",
    address: {
      "@type": "PostalAddress",
