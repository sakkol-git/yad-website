    ...
    <PortalPageLayout>
      ...
      <div className="bg-surface rounded-md p-8 md:p-12 border border-outline-variant/30 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-3xl">
          ...
          <p className="font-body-md text-body-md text-on-surface-variant max-w-2xl">
            Welcome to your personal YAD Cambodia portal. Manage your homestay bookings, track your
            donation history, and find new opportunities to volunteer with our community.
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        >
          {upcomingBooking ? (
            <div className="bg-surface-container p-4 rounded-sm border border-outline-variant/10">
              <p className="font-label-md text-label-md text-primary uppercase tracking-[0.2em] mb-2">
                Upcoming Stay
              </p>
              <p className="font-body-lg text-body-lg text-on-surface mb-1">
                {upcomingBooking.rooms?.name}
              </p>
            ...
            <div className="h-full flex flex-col justify-center">
              <p className="font-body-md text-body-md text-on-surface-variant">
                You don't have any upcoming bookings. Plan your next stay with us!
              </p>
            </div>
          )}
        </SummaryCard>
        ...
        >
          {recentDonation ? (
            <div className="bg-surface-container p-4 rounded-sm border border-outline-variant/10">
              <p className="font-label-md text-label-md text-tertiary uppercase tracking-[0.2em] mb-2">
                Recent Contribution
              </p>
            ...
            <div className="h-full flex flex-col justify-center">
              <p className="font-body-md text-body-md text-on-surface-variant">
                You haven't made any donations yet. Your support helps empower the youth of
                Cambodia.
              </p>
            </div>
          )}
        ...
        >
          {recentVolunteer ? (
            <div className="bg-surface-container p-4 rounded-sm border border-outline-variant/10">
              <p className="font-label-md text-label-md text-secondary uppercase tracking-[0.2em] mb-2">
                Latest Engagement
              </p>
              <p
                className="font-body-lg text-body-lg text-on-surface mb-1 truncate"
                title={recentVolunteer.events?.name || ""}
              >
                {recentVolunteer.events?.name}
              </p>
              <p className="text-sm font-light text-on-surface-variant flex items-center gap-1">
            ...
            <div className="h-full flex flex-col justify-center">
              <p className="font-body-md text-body-md text-on-surface-variant">
                Join our volunteer network and make a direct impact in the community.
              </p>
            </div>
          )}
        </SummaryCard>
