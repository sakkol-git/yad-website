...
export function HomeCTA() {
  return (
    <section className="py-section-gap px-margin-mobile md:px-margin-desktop mb-20">
      <RevealOnScroll
        y={36}
        className="max-w-4xl mx-auto bg-primary text-white border border-outline-variant/30 rounded-md p-12 md:p-20 text-center relative overflow-hidden"
      >
        ...
        <StaggerGroup y={20} className="relative z-10 flex flex-col items-center text-center">
          ...
          <p className="text-sm font-light leading-relaxed text-white/90 max-w-2xl mb-10">
            Whether you choose to fund a scholarship, mentor a student, or partner with our
            initiatives, your involvement is the catalyst for lasting change.
          </p>
