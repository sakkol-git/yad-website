...
export function HomeCTA() {
  return (
    <section className="py-section-gap px-margin-mobile md:px-margin-desktop mb-20">
      <RevealOnScroll y={36} className="max-w-4xl mx-auto bg-primary text-white border border-outline-variant/30 rounded-none p-12 md:p-20 text-center relative overflow-hidden">
