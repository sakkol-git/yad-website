  ...
  return (
    <section className="relative min-h-[100svh] lg:min-h-[921px] flex items-center pt-24 md:pt-32 pb-section-gap px-4 md:px-6 lg:px-8 overflow-hidden bg-surface-container-lowest">
      ...
      <div className="relative z-10 max-w-container-max mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
        ...
        {/* Right Content - Image Card */}
        <div className="relative flex justify-center items-center lg:justify-end mt-16 lg:mt-0 w-full">
          {/* Decorative Blob Background */}
          <div className="absolute inset-0 z-0 flex items-center justify-center pointer-events-none">
            <svg viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg" className="w-[160%] h-[160%] max-w-[800px] text-secondary/20 fill-current">
            ...
            {/* Outline blob offset */}
            <svg viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg" className="absolute w-[170%] h-[170%] max-w-[850px] text-secondary/40 stroke-current fill-transparent stroke-[0.5] rotate-12">
              <path d="M44.7,-76.4C58.9,-69.2,71.8,-59.1,81.3,-46.3C90.8,-33.5,96.8,-18,97.2,-2.4C97.5,13.2,92.1,28.9,82.4,41.9C72.8,55,58.8,65.3,43.5,72.4C28.1,79.5,11.5,83.4,-4.4,81.4C-20.2,79.3,-35.1,71.3,-49.4,61.7C-63.6,52.1,-77.2,40.8,-84.9,26C-92.5,11.1,-94.3,-7.2,-88.3,-23.1C-82.3,-39,-68.5,-52.4,-53.4,-59.2C-38.3,-66.1,-21.9,-66.3,-5.2,-58.4C11.5,-50.5,23.1,-34.5,30.5,-83.4Z" transform="translate(100 100)" />
            </svg>
          </div>

          <ParallaxLayer speed={0.2} className="relative z-10 w-full max-w-[650px] aspect-square lg:aspect-[4/3] rounded-2xl overflow-hidden shadow-2xl border-4 border-surface/50 group">
