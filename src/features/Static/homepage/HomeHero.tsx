...
export function HomeHero() {
  ...
  return (
    ...
    <section
      ref={sectionRef}
      className="relative w-full bg-surface pt-36 pb-16 lg:pt-48 lg:pb-20 overflow-hidden"
    >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-5 flex flex-col z-10">
            ...
            <RevealOnScroll delay={0.3}>
              ...
              >
                We provide vital education, safe housing, and life skills to youth from remote
                provinces and urban slum communities. A foundation for systemic change.
              </p>
            </RevealOnScroll>
            ...
            <RevealOnScroll delay={0.4}>
              <Button
                ...
                onMouseLeave={
                  handleMouseLeave as unknown as React.MouseEventHandler<HTMLButtonElement>
                }
          ...
          >
            <RevealOnScroll delay={0.3} className="w-full h-full relative">
              {HERO_IMAGES.map((img, idx) => {
                ...
                const isPrevious =
                  idx === (currentImageIndex - 1 + HERO_IMAGES.length) % HERO_IMAGES.length;

                return (
                  <div
                    key={img.src.src}
                    className={`absolute inset-0 transition-colors duration-200 ease-in-out duration-[1500ms] ease-[cubic-bezier(0.4,0,0.2,1)] ${
                      isCurrent
