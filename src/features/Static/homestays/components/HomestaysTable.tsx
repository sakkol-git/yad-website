...
export function HomestaysTable({
  ...
  return (
    <div className="bg-surface-container-lowest rounded-xl shadow-sm border border-surface-variant/30 overflow-hidden">
      <div className="p-4 border-b border-surface-variant/30 flex flex-wrap gap-4 items-center justify-between bg-surface-bright">
        <div className="flex flex-wrap items-center gap-3 w-full md:w-auto">
          <div className="relative flex-1 md:w-64">
            ...
            <input
              className="w-full pl-9 pr-3 py-2 bg-surface-container rounded-lg border-none focus:ring-2 focus:ring-secondary text-[14px] placeholder-on-surface-variant/70"
          ...
          <select 
            className="py-2 pl-3 pr-8 bg-surface-container rounded-lg border-none focus:ring-2 focus:ring-secondary text-[14px] text-on-surface-variant cursor-pointer"
