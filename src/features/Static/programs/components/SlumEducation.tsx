          ...
          <div className="lg:col-span-5 lg:sticky lg:top-32">
            ...
            <RevealOnScroll delay={0.1}>
              <div className="space-y-6 font-body-lg text-on-surface-variant leading-relaxed text-lg">
                <p>
                  In urban slums, geography and economics conspire to keep children out of formal
                  education. Waiting for them to come to school is not a strategy; we must take the
                  school to them.
                </p>
                <p>
                  Our mobile tutoring programs deploy directly into marginalized communities,
                  providing the critical literacy and numeracy foundations required to transition
                  these students back into the formal educational system.
                </p>
              </div>
              ...
              <blockquote className="mt-12 pl-6 border-l-4 border-secondary">
                <p className="font-headline-sm text-2xl text-on-surface italic leading-relaxed mb-4">
                  "We don't just teach reading; we teach them that they have the right to be read
                  to, the right to learn, and the right to a future."
                </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 border-t border-outline-variant/30 pt-12">
              <RevealOnScroll delay={0.3}>
                ...
                <p className="text-sm text-on-surface-variant leading-relaxed">
                  Children reached consistently every week across four distinct urban zones.
                </p>
              </RevealOnScroll>
              ...
              <RevealOnScroll delay={0.4}>
                ...
                <p className="text-sm text-on-surface-variant leading-relaxed">
                  Our goal for integrating participating children into formal schooling systems
                  within 12 months.
                </p>
              </RevealOnScroll>
            </div>
