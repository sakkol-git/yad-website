          ...
          <div className="lg:col-span-5 flex flex-col z-10">
            ...
            <RevealOnScroll delay={0.3}>
              <p className="text-base md:text-lg text-on-surface-variant font-light leading-relaxed max-w-sm mb-10">
                Our core programs are not isolated efforts; they are an interconnected ecosystem
                designed to dismantle the specific barriers preventing Cambodian youth from reaching
              ...
              <div className="flex flex-wrap gap-4">
                <Button
                  variant="default"
                  size="lg"
                  className="bg-primary text-white h-12 px-6 hover:bg-primary/90 uppercase text-xs tracking-wider font-bold transition-colors duration-200 ease-in-out"
                  asChild
                >
