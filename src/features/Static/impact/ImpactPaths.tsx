    ...
    >
      <div className="max-w-container-max mx-auto">
        ...
        <StaggerGroup y={28} className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* Fund */}
          <div className="bg-surface rounded-lg p-8 shadow-ambient hover-lift flex flex-col group relative overflow-hidden">
          ...
          {/* Mentor */}
          <div className="bg-surface rounded-lg p-8 shadow-ambient hover-lift flex flex-col group relative overflow-hidden md:-translate-y-4">
