...
export function EventHero() {
  return (
    <section className="relative w-full bg-surface pt-26 pb-16 lg:pb-20 overflow-hidden">
          ...
          <div className="lg:col-span-5 flex flex-col z-10">
            ...
            <RevealOnScroll delay={0.3}>
              <p className="text-base md:text-lg text-on-surface-variant font-light leading-relaxed max-w-sm mb-10">
                ...
                opportunities to get involved or explore the impact of our recent community
                initiatives.
              </p>
            </RevealOnScroll>
          </div>
