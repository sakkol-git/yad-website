      ...
      cell: (row) => (
        <div className="flex justify-end items-center gap-2">
          {row.status === "Payment Pending" ? (
            <Button variant="default" size="sm" onClick={() => handlePayment(row)}>
              Pay Now
            </Button>
          ) : (
