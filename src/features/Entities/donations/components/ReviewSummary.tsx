    ...
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16 items-start">
      ...
      <div className="lg:col-span-7 xl:col-span-8 flex flex-col gap-8">
          ...
          <div className="mt-10 pt-6 border-t border-outline-variant/30">
            <label className="flex items-start gap-4 cursor-pointer group">
              <div className="relative flex items-center justify-center mt-1">
                <input defaultChecked className="peer appearance-none w-5 h-5 border border-outline-variant/50 rounded-md text-primary focus:ring-1 focus:ring-primary focus:ring-offset-background checked:bg-primary checked:border-primary transition-colors duration-150" type="checkbox" />
        ...
        <div className="flex flex-col-reverse md:flex-row items-center justify-between gap-4 mt-4">
          <Button variant="outline" size="lg" className="w-full md:w-auto px-8 rounded-md border-primary text-primary hover:bg-primary hover:text-white uppercase tracking-widest text-[10px] font-bold h-12 transition-colors" asChild>
            <Link href="/donate/payment">
              Back
            </Link>
          </Button>
          <Button variant="default" size="lg" className="w-full md:w-auto px-10 gap-2 hover:-translate-y-1 bg-primary hover:bg-primary/90 text-white rounded-md uppercase tracking-widest text-[10px] font-bold h-12 transition-colors duration-150" asChild>
