  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16 items-start">
      ...
      <div className="lg:col-span-7 xl:col-span-8 flex flex-col gap-8">
        <div>
          ...
          <p className="text-base text-on-surface-variant font-light leading-relaxed">
            Please review the details below before completing your contribution to Youth Advancement
            for Development.
          </p>
        </div>

        {/* Details Card */}
        <div className="bg-surface rounded-md p-6 md:p-10 border border-outline-variant/30 relative overflow-hidden">
          <div className="flex justify-between items-center mb-8 pb-4 border-b border-outline-variant/30">
            ...
            <Button
              variant="ghost"
              className="px-2 py-1 h-auto text-secondary hover:text-primary gap-1"
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 relative z-10">
            ...
            <div className="flex flex-col gap-6">
              <div>
                <span className="block kicker-label text-on-surface mb-2">Donor Name</span>
                <span className="text-lg font-light text-on-surface">Alex Mercer</span>
              </div>
              <div>
                <span className="block kicker-label text-on-surface mb-2">Email Address</span>
            ...
            <div className="flex flex-col gap-6">
              ...
              <div>
                <span className="block kicker-label text-on-surface mb-2">Billing Zip Code</span>
          ...
          <div className="mt-10 pt-6 border-t border-outline-variant/30">
            <label className="flex items-start gap-4 cursor-pointer group">
              <div className="relative flex items-center justify-center mt-1">
                <input
                  defaultChecked
                  className="peer appearance-none w-5 h-5 border border-outline-variant/50 rounded-md text-primary focus:ring-1 focus:ring-primary focus:ring-offset-background checked:bg-primary checked:border-primary transition-colors duration-150"
                  type="checkbox"
                />
                <span className="material-symbols-outlined text-white absolute text-sm opacity-0 peer-checked:opacity-100 pointer-events-none">
                  check
                </span>
              </div>
              <span className="text-sm font-light text-on-surface-variant group-hover:text-on-surface transition-colors leading-relaxed">
                I agree to cover the 3% transaction fee so that 100% of my donation goes directly to
                the programs.
              </span>
            </label>
          </div>
      ...
      <div className="lg:col-span-5 xl:col-span-4 sticky top-32">
        <div className="bg-primary text-white rounded-md border border-outline-variant/30 flex flex-col">
          ...
          <div className="p-6 md:p-8 flex flex-col gap-6">
            ...
            <div className="bg-white/10 rounded-md border border-white/20 p-5 flex items-start gap-4">
              <div className="bg-white text-primary p-2 rounded-md shrink-0 flex items-center justify-center border border-white/20">
                <span className="material-symbols-outlined text-xl">psychiatry</span>
              </div>
              <p className="text-sm font-light leading-relaxed m-0">
                Your $50 monthly contribution provides essential learning materials for one student
