...
export function StripeEmbeddedCheckout({ id, type, amount, email }: StripeEmbeddedCheckoutProps) {
  ...
  if (error) {
    return (
      <div className="p-6 text-center bg-error-container text-error rounded-md-md border border-error/20">
  ...
  if (!clientSecret) {
    return (
      <div className="flex flex-col items-center justify-center p-12 text-on-surface-variant">
        <div className="w-10 h-10 border-4 border-primary border-t-transparent rounded-md-full animate-spin mb-4" />
  ...
  return (
    <div className="w-full bg-surface rounded-md-md overflow-hidden p-2 border border-outline-variant/30">
