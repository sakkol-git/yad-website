    ...
    <section className="bg-surface border-t border-outline-variant/30 py-24">
      <div className="max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          <div className="bg-surface p-8 rounded-md border border-outline-variant/30 hover:border-primary transition-colors duration-300">
            <div className="text-primary text-[3rem] font-light tracking-tighter mb-4">$25</div>
          ...
          <div className="bg-surface p-8 rounded-md border-2 border-primary relative hover:bg-primary/5 transition-colors duration-300">
            ...
            <p className="text-sm font-light text-on-surface-variant leading-relaxed">
              Provides 1 month of safe housing, leadership training, and university access at our
              Dormitory and Leadership Training Centre.
            </p>
          </div>
          <div className="bg-surface p-8 rounded-md border border-outline-variant/30 hover:border-primary transition-colors duration-300">
            <div className="text-primary text-[3rem] font-light tracking-tighter mb-4">$100</div>
            <p className="text-sm font-light text-on-surface-variant leading-relaxed">
              Sponsors a Mobile Tutoring Unit, bringing basic literacy to over 100 children in
              marginalized urban slums.
            </p>
          </div>
        </div>
        <Link
