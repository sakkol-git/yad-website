...
export async function createStripeCheckoutSession({
  ...
  try {
    ...
    const sessionData: any = {
      ...
      mode: "payment",
      success_url: `${origin}/${type === "donation" ? "donate/success" : "portal/bookings"}?session_id={CHECKOUT_SESSION_ID}`,
      cancel_url: `${origin}/${type === "donation" ? "donate/payment" : "portal/bookings"}`,
      metadata: {
        ...metadata,
        type,
        referenceId,
