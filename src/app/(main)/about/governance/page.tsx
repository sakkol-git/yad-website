...
import { CommunityStructureGovernance } from "@/features/Entities/members/components/CommunityStructureGovernace";

export const metadata: Metadata = {
  title: "Leadership & Governance | YAD Cambodia",
  description:
    "Meet the dedicated team and board members driving youth empowerment at YAD Cambodia.",
};
        ...
        <div className="pt-24 pb-16 lg:pt-32 lg:pb-24 border-b border-outline-variant/30 mb-16">
          <RevealOnScroll className="max-w-4xl">
            ...
            <p className="text-lg md:text-xl text-on-surface-variant font-light leading-relaxed max-w-2xl">
              YAD is guided by a dedicated team of professionals and a volunteer Board of Directors
              committed to transparency, accountability, and sustainable impact.
            </p>
          </RevealOnScroll>
        </div>

        <CommunityStructureGovernance />
