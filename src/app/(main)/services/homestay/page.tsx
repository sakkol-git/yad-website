...
export const metadata: Metadata = {
  ...
  description:
    "Stay with us at the YAD Homestay. An authentic Cambodian experience where all proceeds fund our NGO operations and youth programs.",
};
  ...
  return (
    <main className="relative w-full bg-surface pt-36 pb-16 lg:pt-48 lg:pb-24 overflow-hidden border-b border-outline-variant/30">
      <RevealOnScroll className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-container-max relative z-10">
        ...
        <div className="mb-16">
          <span className="block text-primary kicker-label mb-4">Services</span>
          <TextReveal
            as="h1"
          ...
          <p className="text-base md:text-lg text-on-surface-variant font-light leading-relaxed max-w-3xl">
            Experience authentic Cambodian culture while making a difference. Our Homestay is a
            social enterprise where 100% of proceeds fund YAD operations.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-16">
          <div>
            ...
            <p className="text-base md:text-lg text-on-surface-variant font-light leading-relaxed mb-8">
              Whether you are a short-term visitor, a volunteer, or looking for a long-term stay in
              Phnom Penh, our central location offers comfortable living alongside our community. By
              staying with us, you directly fund our youth empowerment programs.
            </p>
            ...
            <p className="text-base md:text-lg text-on-surface-variant font-light leading-relaxed mb-6">
              Guests at the homestay have the chance to try authentic, home-style Khmer food cooked
              by our university residents from the DLTC program. Residents are also happy to teach
              guests Khmer cooking techniques!
            </p>
            <ul className="list-disc pl-5 mb-10 space-y-2 text-on-surface-variant text-base md:text-lg font-light leading-relaxed">
              <li>
                <strong>Breakfast / Lunch / Dinner:</strong> $2.00 USD per meal
              </li>
            </ul>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4 h-fit">
            <div className="bg-surface-container-high dark:bg-surface-container-high backdrop-blur-xl border border-outline-variant/30 hover:border-primary/40 transition-colors duration-300 rounded-md overflow-hidden shadow-ambient group">
              <div className="aspect-square flex flex-col items-center justify-center p-4 text-center">
                <span className="material-symbols-outlined text-4xl text-primary mb-3 block group-hover:scale-110 transition-transform duration-300">
                  bed
                </span>
        ...
        <div className="bg-surface-container-high dark:bg-surface-container-high backdrop-blur-xl border border-outline-variant/30 rounded-md p-10 mb-40 shadow-ambient">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            {/* Short Term */}
            <div>
              <h3 className="text-2xl font-light text-on-surface tracking-tight mb-6 border-b border-outline-variant/30 pb-4">
                Short Term (Nightly)
              </h3>
          ...
          <p className="text-xs text-on-surface-variant text-center mt-6 italic">
            *Rates are subject to change. Please contact us to confirm current availability and
            pricing.
          </p>
        </div>
      </RevealOnScroll>
