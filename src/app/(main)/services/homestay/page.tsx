      ...
      <RevealOnScroll className="max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-16">
          ...
          <div className="grid grid-cols-2 gap-4 h-fit">
            <div className="bg-surface-container rounded-md overflow-hidden shadow-sm border border-transparent hover:border-primary/40 transition-colors duration-300 group">
              <div className="aspect-square bg-surface-variant flex flex-col items-center justify-center p-4 text-center">
                <span className="material-symbols-outlined text-4xl text-on-surface-variant mb-2 block group-hover:scale-110 transition-transform duration-300">bed</span>
                <p className="text-sm font-medium">Single Rooms</p>
              </div>
            </div>
            <div className="bg-surface-container rounded-md overflow-hidden shadow-sm border border-transparent hover:border-primary/40 transition-colors duration-300 group">
              <div className="aspect-square bg-surface-variant flex flex-col items-center justify-center p-4 text-center">
                <span className="material-symbols-outlined text-4xl text-on-surface-variant mb-2 block group-hover:scale-110 transition-transform duration-300">king_bed</span>
                <p className="text-sm font-medium">Double Rooms</p>
              </div>
            </div>
            <div className="col-span-2 bg-surface-container rounded-md overflow-hidden shadow-sm border border-transparent hover:border-primary/40 transition-colors duration-300 group">
              <div className="h-32 bg-surface-variant flex flex-col items-center justify-center p-4 text-center">
                <span className="material-symbols-outlined text-4xl text-on-surface-variant mb-2 block group-hover:scale-110 transition-transform duration-300">bunkbed</span>
