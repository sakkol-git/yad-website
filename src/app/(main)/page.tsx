...
export const metadata: Metadata = {
  ...
  description:
    "Youth Advancement for Development (YAD) is an independent Cambodian NGO focused on youth empowerment, housing, leadership training, and community education.",
  openGraph: {
    title: "YAD | Youth Advancement for Development — NGO in Cambodia",
    description:
      "Youth Advancement for Development (YAD) is an independent Cambodian NGO focused on youth empowerment, housing, leadership training, and community education.",
