        ...
        <div className="max-w-3xl mx-auto">
          <RevealOnScroll>
            <div className="space-y-16">
              <section>
                <h2 className="text-2xl font-light tracking-tight text-on-surface mb-6">1. Acceptance of Terms</h2>
              ...
              <section>
                <h2 className="text-2xl font-light tracking-tight text-on-surface mb-6">2. Use of Content</h2>
                <p className="text-base font-light text-on-surface-variant leading-relaxed">
              ...
              <section>
                <h2 className="text-2xl font-light tracking-tight text-on-surface mb-6">3. Donations</h2>
                <p className="text-base font-light text-on-surface-variant leading-relaxed">
              ...
              <section>
                <h2 className="text-2xl font-light tracking-tight text-on-surface mb-6">4. Limitation of Liability</h2>
                <p className="text-base font-light text-on-surface-variant leading-relaxed">
              ...
              <section>
                <h2 className="text-2xl font-light tracking-tight text-on-surface mb-6">5. Changes to Terms</h2>
                <p className="text-base font-light text-on-surface-variant leading-relaxed">
