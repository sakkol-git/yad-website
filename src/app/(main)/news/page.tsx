  ...
  return (
    <main className="flex-grow pt-32 pb-section-gap px-margin-mobile md:px-margin-desktop bg-surface">
      ...
      <div className="max-w-container-max mx-auto">
        ...
        <div className="bg-surface-container-low rounded-md p-12 text-center border-2 border-dashed border-outline-variant/40 flex flex-col items-center justify-center min-h-[400px]">
