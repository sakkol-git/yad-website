...
export const metadata: Metadata = {
  ...
  description:
    "Volunteer with Youth Advancement for Development (YAD) in Cambodia. Teach, build, and explore while staying at our central Phnom Penh homestay.",
};
    ...
    <main className="pt-32 pb-section-gap max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop">
      ...
      <div className="mb-12">
        ...
        <p className="font-body-lg text-body-lg text-on-surface-variant max-w-3xl">
          Join us for a life-changing experience in Cambodia. Whether you have two weeks or two
          months, your time volunteering directly supports our youth empowerment programs.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 mb-16">
        <div className="lg:col-span-2">
          ...
          <p className="font-body-md text-body-md text-on-surface-variant mb-4">
            During your time with us, we plan several excursions to must-see sights around Cambodia.
            In Phnom Penh, participants have the option to visit the breathtaking Royal Palace, the
            National Museum, and important historical sites like the Choeung Ek Killing Field and
            S-21 Toul Sleng Museum. We will introduce you to local cuisine and market shopping.
          </p>
          <p className="font-body-md text-body-md text-on-surface-variant mb-8">
            Cambodia prides itself on its temples, and we are happy to share our spectacular history
            during visits to Wat Phnom and Angkor Wat in Siem Reap. You&apos;ll have the option to
            experience a rural Khmer village homestay to immerse yourself in the culture!
          </p>
        </div>
        ...
        <div>
          <div className="bg-surface-container-low border border-surface-container-high rounded-md p-6 shadow-sm">
            ...
            <h4 className="font-label-bold text-label-bold text-on-surface mb-2 border-b pb-1">
              Nightly Cost
            </h4>
            <div className="text-sm text-on-surface-variant mb-4 space-y-1">
              <div className="flex justify-between">
                <span>Single Room:</span> <span>$7–$9</span>
              </div>
              <div className="flex justify-between">
                <span>Double Room:</span> <span>$10–$12</span>
              </div>
              <div className="flex justify-between">
                <span>Group Dorm:</span> <span>$8 per person</span>
              </div>
            </div>
            ...
            <div className="text-sm text-on-surface-variant mb-6 space-y-1">
              <div className="flex justify-between">
                <span>Breakfast:</span> <span>$2.00</span>
              </div>
              <div className="flex justify-between">
                <span>Lunch:</span> <span>$3.50</span>
              </div>
              <div className="flex justify-between">
                <span>Dinner:</span> <span>$2.00</span>
              </div>
            </div>
