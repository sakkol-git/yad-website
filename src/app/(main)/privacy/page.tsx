        ...
        <div className="max-w-3xl mx-auto">
          <RevealOnScroll>
            <div className="space-y-16">
              <section>
                <h2 className="text-2xl font-light tracking-tight text-on-surface mb-6">1. Information We Collect</h2>
              ...
              <section>
                <h2 className="text-2xl font-light tracking-tight text-on-surface mb-6">2. How We Use Your Information</h2>
                <p className="text-base font-light text-on-surface-variant leading-relaxed">
              ...
              <section>
                <h2 className="text-2xl font-light tracking-tight text-on-surface mb-6">3. Data Security</h2>
                <p className="text-base font-light text-on-surface-variant leading-relaxed">
              ...
              <section>
                <h2 className="text-2xl font-light tracking-tight text-on-surface mb-6">4. Your Rights</h2>
                <p className="text-base font-light text-on-surface-variant leading-relaxed">
              ...
              <section>
                <h2 className="text-2xl font-light tracking-tight text-on-surface mb-6">5. Contact Us</h2>
                <p className="text-base font-light text-on-surface-variant leading-relaxed">
                  If you have any questions about this Privacy Policy, please contact us at: <br /><br />
                  <strong className="font-bold text-on-surface">Email:</strong> info@yadkh.org <br />
                  <strong className="font-bold text-on-surface">Address:</strong> Phnom Penh, Cambodia
                </p>
              </section>
            </div>
          </RevealOnScroll>
