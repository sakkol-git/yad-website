...
export const metadata: Metadata = {
  ...
  description:
    "Learn about YAD's Dormitory & Leadership Training Centre (DLTC) providing housing, scholarships, and life skills training to marginalized Cambodian youth.",
};
      ...
      <RevealOnScroll className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-container-max relative z-10">
        ...
        <div className="mb-16">
          ...
          <p className="text-base md:text-lg text-on-surface-variant font-light leading-relaxed max-w-3xl">
            The DLTC is a core program of Youth Advancement for Development (YAD) supporting
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          <div>
            ...
            <p className="text-base md:text-lg text-on-surface-variant font-light leading-relaxed mb-8">
              Currently supporting <strong>18 talented students</strong>, the DLTC provides far more
              than just a place to sleep. We offer comprehensive housing, scholarships, and an
              immersive environment focused on leadership and life skills to ensure successful
              university access and graduation.
            </p>
            ...
            <ul className="list-disc pl-5 mb-8 space-y-2 text-on-surface-variant text-base md:text-lg font-light leading-relaxed">
              ...
              <li>
                Weekly leadership seminars on conflict resolution, mental health, and job seeking
              </li>
