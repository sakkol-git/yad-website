      ...
      <div className="w-full lg:w-2/3">
        ...
        <div className="bg-surface-container-lowest rounded-xl ambient-shadow p-6 md:p-10 relative overflow-hidden">
          ...
          <div className="flex justify-between items-center">
            <Button variant="ghost" className="text-on-surface-variant hover:text-primary gap-1" asChild>
              <Link href="/donate/flow">
                <span className="material-symbols-outlined text-sm">arrow_back</span> Back
              </Link>
            </Button>
            <Button variant="primary" className="rounded-full gap-2 hover:scale-105 px-8" asChild>
              <Link href="/donate/review">
