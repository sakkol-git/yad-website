        ...
        <div className="w-full lg:w-2/3">
          ...
          <div className="flex items-center gap-4 mb-8">
            <div className="flex items-center gap-2">
              <div className="w-8 h-8 rounded-full bg-primary text-on-primary flex items-center justify-center font-label-bold text-label-bold">
                1
              </div>
              <span className="font-label-bold text-label-bold text-primary hidden md:inline">
                Details
              </span>
            </div>
            <div className="h-px bg-surface-variant flex-grow" />
            <div className="flex items-center gap-2">
              <div className="w-8 h-8 rounded-full bg-surface-variant text-on-surface-variant flex items-center justify-center font-label-bold text-label-bold transition-colors">
                2
              </div>
              <span className="font-label-bold text-label-bold text-on-surface-variant hidden md:inline transition-colors">
                Payment
              </span>
            </div>
            <div className="h-px bg-surface-variant flex-grow" />
          ...
          <div className="bg-surface-container-lowest rounded-xl ambient-shadow p-6 md:p-10 relative overflow-hidden">
            ...
            <div>
              ...
              <div className="flex justify-end">
                <Button variant="secondary" size="lg" className="rounded-full gap-2 hover:scale-105 px-8">
                  Continue to Payment{" "}
