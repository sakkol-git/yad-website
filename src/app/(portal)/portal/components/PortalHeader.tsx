        ...
        <div className="flex justify-between items-center h-16">
          <div className="flex items-center gap-4 md:gap-8">
            <Link href="/portal/dashboard" className="flex items-center gap-2 group">
              <div className="w-8 h-8 bg-secondary rounded-sm flex items-center justify-center shadow-sm group-hover:scale-105 transition-transform duration-300">
                <span className="material-symbols-outlined text-on-secondary text-xl">group</span>
              </div>
              <span className="font-bold text-xl tracking-tight text-on-surface group-hover:text-secondary transition-colors duration-300">
                YAD<span className="text-secondary">Portal</span>
              </span>
            </Link>
            ...
            <nav className="hidden md:flex items-center gap-1">
              <Link
                ...
                className="px-4 py-2 rounded-md text-sm font-medium text-on-surface hover:bg-surface-container transition-colors duration-300 min-h-[44px] flex items-center"
              >
                Overview
              </Link>
              <Link
                href="/portal/bookings"
                className="px-4 py-2 rounded-md text-sm font-medium text-on-surface-variant hover:text-on-surface hover:bg-surface-container transition-colors duration-300 min-h-[44px] flex items-center"
              >
                My Bookings
              </Link>
              <Link
          ...
          <div className="flex items-center gap-2 sm:gap-4">
            <Link
              ...
              className="hidden sm:flex items-center gap-2 px-4 py-2 rounded-md border border-outline-variant/50 text-sm font-medium text-on-surface hover:bg-surface-container hover:border-outline-variant transition-colors duration-200 ease-in-out min-h-[44px]"
            >
        ...
        <div className="md:hidden border-t border-outline-variant/30 bg-surface-container-lowest">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            <Link
              ...
              href="/portal/dashboard"
              className="block px-3 py-2 rounded-md text-base font-medium text-on-surface hover:bg-surface-container transition-colors duration-300 min-h-[44px]"
            >
              Overview
            </Link>
            <Link
              onClick={() => setMobileMenuOpen(false)}
              href="/portal/bookings"
              className="block px-3 py-2 rounded-md text-base font-medium text-on-surface-variant hover:text-on-surface hover:bg-surface-container transition-colors duration-300 min-h-[44px]"
            >
              My Bookings
            </Link>
            <Link
            ...
            <Link
              onClick={() => setMobileMenuOpen(false)}
              href="/"
              className="sm:hidden block px-3 py-2 rounded-md text-base font-medium text-on-surface-variant hover:text-on-surface hover:bg-surface-container transition-colors duration-300 min-h-[44px]"
            >
              Back to Website
            </Link>
