    ...
    <PortalPageLayout>
      <div className="space-y-8">
        <div className="flex flex-col gap-4 border-b border-outline-variant/30 pb-6 mb-6">
          <div className="h-10 bg-surface-variant/50 rounded-md-md w-1/3 skeleton-shimmer"></div>
          <div className="h-4 bg-surface-variant/50 rounded-md-md w-1/2 skeleton-shimmer"></div>
        </div>
