...
export default async function AdminProgramsPage(props: {
  ...
  if (!result.success || !result.data) {
    return (
      <AdminPageLayout>
        <div className="p-8 text-center text-error">Failed to load programs. {result.error}</div>
      </AdminPageLayout>
    );
  }
  ...
  return (
    <AdminPageLayout>
      ...
      <Suspense
        fallback={
          <div className="p-8 text-center text-on-surface-variant">Loading programs...</div>
        }
      >
