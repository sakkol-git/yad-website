...
export default async function AdminInquiriesPage(props: {
  ...
  if (!result.success || !result.data) {
    return (
      <AdminPageLayout>
        <div className="p-8 text-center text-error">Failed to load inquiries. {result.error}</div>
      </AdminPageLayout>
    );
  }
  ...
  return (
    <AdminPageLayout>
      ...
      <Suspense
        fallback={
          <div className="p-8 text-center text-on-surface-variant">Loading inquiries...</div>
        }
      >
