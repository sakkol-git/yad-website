...
function UploadForm({ onSuccess }: { onSuccess: () => void }) {
  ...
  return (
    <form
      ...
      className="mb-8 bg-surface-container-low p-6 rounded-lg border border-surface-variant flex flex-col gap-4 max-w-xl"
    >
...
function EditModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-neutral-900/50 backdrop-blur-sm p-4">
      <div className="bg-surface rounded-xl border border-outline-variant/30 shadow-xl max-w-md w-full p-6">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          {error && (
            <p className="text-error text-sm bg-error-container/30 px-3 py-2 rounded">
              {error}
            </p>
          )}
...
function DeleteModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-neutral-900/50 backdrop-blur-sm p-4">
      <div className="bg-surface rounded-xl border border-outline-variant/30 shadow-xl max-w-sm w-full p-6">
...
export function ReportsTable({
  ...
  return (
    <div className="p-6">
      ...
      {/* Table / Empty State */}
      {reports.length === 0 ? (
        <div className="text-center p-12 text-on-surface-variant bg-surface-container/30 rounded-lg border border-dashed border-outline-variant/40">
